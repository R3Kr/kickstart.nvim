...
require('lazy').setup(
  {
      ...
      config = function()
        ...
        vim.api.nvim_create_autocmd('LspAttach', {
          ...
          callback = function(event)
            ...
            map('ö', vim.lsp.buf.hover, '[Ö]Type Hint')
    ...
    },
    {
      ...
      config = function()
        require('neo-tree').setup { window = { filesystem = { hijack_netrw_behaviour = 'open_default' } } }
        vim.keymap.set('n', '<leader>n', function()
          require('neo-tree.command').execute {
            toggle = true,
          }
        end, { desc = 'Toggles Neotree' })
      end,
    },
    {
      ...
      init = function()
        ...
        vim.g.magma_image_provider = 'ueberzug' -- or "kitty" if you use Kitty terminal
      ...
      config = function()
        -- You might need to run :UpdateRemotePlugins after installation
      end,
    },
  },
